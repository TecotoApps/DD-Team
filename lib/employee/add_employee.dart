        ...
        child: Column(
          ...
          children: [
            ...
            TextFieldCurvedEdges(
                ...
                borderColor: AppColors.card_border_color),
            Gap(8),
            ...
            RoundedElevatedButton(
              ...
              onPressed: () async{
                ...
                String joinDate = selectedDates != null ? DateFormat('yyyy-MM-dd').format(selectedDates!) : '';
                if (name.isEmpty || phone.isEmpty || email.isEmpty || description.isEmpty || joinDate.isEmpty) {
                ...
                AddEmployeeModel addEmployeeModel= await DashboardController().addEmployeeByHR(
                  name,
                  phone,
                  email,
                  description,
